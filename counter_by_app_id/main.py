...
def get_config():
    ...
    try:
        ...
        # queues
        config_params["CONSUME_QUEUE_SUFIX"] = os.getenv(
            "CONSUME_QUEUE_SUFIX", config["DEFAULT"]["CONSUME_QUEUE_SUFIX"]
        )
...
def main():
    ...
    counter = CounterByAppId(config, middleware, activity_log)
