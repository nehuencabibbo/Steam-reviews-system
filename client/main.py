...
def get_config():
    ...
    try:
        ...
        # sender queues
        config_params["GAMES_QUEUE"] = os.getenv(
            "GAMES_QUEUE", config["DEFAULT"]["GAMES_QUEUE"]
        )
        config_params["REVIEWS_QUEUE"] = os.getenv(
            "REVIEWS_QUEUE", config["DEFAULT"]["REVIEWS_QUEUE"]
        )
        ...
        # file path
        config_params["GAME_FILE_PATH"] = os.getenv(
            "GAME_FILE_PATH", config["DEFAULT"]["GAME_FILE_PATH"]
        )
        config_params["REVIEWS_FILE_PATH"] = os.getenv(
            "REVIEWS_FILE_PATH", config["DEFAULT"]["REVIEWS_FILE_PATH"]
        )

        config_params["LOGGING_LEVEL"] = os.getenv(
            "LOGGING_LEVEL", config["DEFAULT"]["LOGGING_LEVEL"]
        )
        config_params["SENDING_WAIT_TIME"] = int(
            os.getenv("SENDING_WAIT_TIME", config["DEFAULT"]["SENDING_WAIT_TIME"])
        )
        ...
        config_params["SERVER_PORT"] = os.getenv(
